...
app.include_router(drills_routes.router, dependencies=authorize)
app.include_router(ship_drill_assignment_routes.router, prefix="/ships", dependencies=authorize)
